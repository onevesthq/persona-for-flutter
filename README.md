...
Native implementation of the [Persona Inquiry flow v2](https://docs.withpersona.com/docs) for Flutter.
...
Change the minimum Android sdk version to 31 (or higher) in your `android/app/build.gradle` file.
...
This dependency was forked from [https://github.com/jorgefspereira/persona_flutter] and updated to support the v2 persona mobile sdk